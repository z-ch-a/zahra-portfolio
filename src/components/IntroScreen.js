...
export function startIntroScreen() {
  ...
  const bootButton =
    document.querySelector("#boot-button");

  const terminal =
    document.querySelector("#terminal");

  const continueArea =
    document.querySelector("#continue-area");
  ...
  function createMechanicalKeySound(
    character
  ) {
  ...
  async function startBootSequence() {
    ...
    continueArea.classList.add(
      "continue-area--visible"
    );
  }
